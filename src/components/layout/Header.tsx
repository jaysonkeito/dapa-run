            ...
            <div className="flex items-center justify-between h-16 sm:h-20">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg sm:text-2xl font-light tracking-[0.15em] text-gray-400 -mt-1" style={{ letterSpacing: '0.15em' }}>
                      ...
                      <div className="p-6 border-b bg-gradient-to-r from-orange-500 to-orange-600">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-white/70 text-lg font-light tracking-[0.15em]">{siteSettings.siteNameSuffix}</p>
                          </div>
                        </div>
                      </div>
