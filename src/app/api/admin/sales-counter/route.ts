...
// GET - List all Sales Counter orders with items
export async function GET() {
  try {
    ...
    console.error("Sales Counter orders fetch error:", error)
    return NextResponse.json({ error: "Internal server error" }, { status: 500 })
  }
}

// POST - Create a new Sales Counter order
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("Sales Counter order create error:", error)
    return NextResponse.json({ error: "Internal server error" }, { status: 500 })
  }
}
