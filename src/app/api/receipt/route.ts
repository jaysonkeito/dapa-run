...
function buildReceiptSVG(data: {
  ...
  const detailRow = (label: string, value: string, y: number) => `
    <text x="80" y="${y}" font-size="16" fill="#6B7280" font-family="Arial, Helvetica, sans-serif">${label}</text>
    <text x="720" y="${y}" text-anchor="end" font-size="16" font-weight="600" fill="#1F2937" font-family="Arial, Helvetica, sans-serif">${value}</text>
  ...
  const svg = `<svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="${cx}" y="57" text-anchor="middle" font-size="20" font-weight="900" fill="#FFFFFF" font-family="Arial, Helvetica, sans-serif">DR</text>

    <!-- DAPA RUN title -->
    <text x="${cx}" y="100" text-anchor="middle" font-size="28" font-weight="900" fill="#FFFFFF" letter-spacing="2" font-family="Arial, Helvetica, sans-serif">DAPA RUN</text>

    <!-- Suffix -->
    <text x="${cx}" y="125" text-anchor="middle" font-size="14" font-weight="300" fill="rgba(255,255,255,0.7)" letter-spacing="3" font-family="Arial, Helvetica, sans-serif">${safeSuffix.toUpperCase()}</text>

    <!-- RECEIPT label -->
    <text x="${cx}" y="180" text-anchor="middle" font-size="24" font-weight="700" fill="#1F2937" font-family="Arial, Helvetica, sans-serif">OFFICIAL RECEIPT</text>
    <text x="${cx}" y="200" text-anchor="middle" font-size="12" fill="#9CA3AF" letter-spacing="2" font-family="Arial, Helvetica, sans-serif">REGISTRATION PAYMENT</text>
    ...
    <text x="${cx}" y="265" text-anchor="middle" font-size="14" fill="#9A3412" font-weight="500" font-family="Arial, Helvetica, sans-serif">AMOUNT PAID</text>
    <text x="${cx}" y="300" text-anchor="middle" font-size="36" font-weight="900" fill="#EA580C" font-family="Arial, Helvetica, sans-serif">${amountStr}</text>
    ...
    <text x="100" y="778" font-size="13" fill="#166534" font-family="Arial, Helvetica, sans-serif">Payment Reference: ${safeRef}</text>
    <circle cx="700" cy="772" r="10" fill="#22C55E"/>
    <text x="700" y="777" text-anchor="middle" font-size="11" font-weight="700" fill="#FFFFFF" font-family="Arial, Helvetica, sans-serif">✓</text>
    ` : ''}
    ...
    <text x="${cx}" y="880" text-anchor="middle" font-size="13" font-weight="700" fill="#1E40AF" font-family="Arial, Helvetica, sans-serif">PRESENT THIS RECEIPT TO CLAIM YOUR RACE KIT</text>
    <text x="${cx}" y="902" text-anchor="middle" font-size="11" fill="#3B82F6" font-family="Arial, Helvetica, sans-serif">Show this receipt to the staff/organizer on event day</text>

    <!-- Bottom branding -->
    <line x1="80" y1="950" x2="720" y2="950" stroke="#E5E7EB" stroke-width="1"/>

    <text x="${cx}" y="980" text-anchor="middle" font-size="11" fill="#9CA3AF" font-family="Arial, Helvetica, sans-serif">This is an official receipt from DAPA RUN ${safeSuffix}</text>
    <text x="${cx}" y="1000" text-anchor="middle" font-size="10" fill="#D1D5DB" font-family="Arial, Helvetica, sans-serif">Generated on ${formatDate(new Date())} at ${formatTime(new Date())}</text>
