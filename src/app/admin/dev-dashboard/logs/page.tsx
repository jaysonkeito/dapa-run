      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <Select value={actionFilter} onValueChange={(v) => { setActionFilter(v); setPage(1) }}>
          ...
          <SelectContent>
            ...
            <SelectItem value="DEVELOPER_UPDATE_SETTINGS">Dev Update Settings</SelectItem>
            <SelectItem value="DEVELOPER_UPDATE_USER">Dev Update User</SelectItem>
            <SelectItem value="DEVELOPER_UPDATE_EVENT">Dev Update Event</SelectItem>
            <SelectItem value="DEVELOPER_UPDATE_MERCH">Dev Update Merch</SelectItem>
          </SelectContent>
        </Select>
