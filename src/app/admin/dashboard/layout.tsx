        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-800">
          ...
          {!collapsed && (
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-gray-400 text-lg font-light tracking-[0.15em] -mt-1 truncate">{siteSettings.siteNameSuffix}</span>
            </div>
          )}
        </div>
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <h1 className="text-white font-bold text-lg">DAPA RUN</h1>
                  <span className="text-gray-400 text-lg font-light tracking-[0.15em] -mt-1">{siteSettings.siteNameSuffix}</span>
                </div>
              </div>
