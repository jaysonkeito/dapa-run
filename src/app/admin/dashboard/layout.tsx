    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-800">
          <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center overflow-hidden">
          ...
          {!collapsed && (
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-gray-400 text-[20px] font-light tracking-[0.15em] -mt-1 truncate">{siteSettings.siteNameSuffix}</span>
            </div>
          )}
        </div>
        ...
        {/* Collapse toggle - chat.z.ai style: hover shows icon, click to toggle */}
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <h1 className="text-white font-bold text-lg">DAPA RUN</h1>
                  <span className="text-gray-400 text-[20px] font-light tracking-[0.15em] -mt-1">{siteSettings.siteNameSuffix}</span>
                </div>
              </div>
